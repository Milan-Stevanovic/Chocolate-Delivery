...
export class CustomerService {
    ...
    getAllPastOrders(customerId: number): Observable<OrderDisplay[]>{
      return this.http.post<OrderDisplay[]>(environment.serverURL + '/api/customer/getAllPastOrders', customerId);
    }
}
